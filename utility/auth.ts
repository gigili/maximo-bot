...
export function getTwitchToken(): Promise<string> {
	return axios.post(`https://id.twitch.tv/oauth2/token?scope=user:edit&response_type=token&client_secret=${client_secret}&grant_type=client_credentials&client_id=${client_id}`, {
